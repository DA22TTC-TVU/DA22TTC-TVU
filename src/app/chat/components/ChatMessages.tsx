                    ...
                    {messages.map((message, index) => (
                        ...
                        >
                            <div className="flex flex-col">
                                <div className={`${message.role === 'user' && editingIndex !== index
                                    ? 'mx-2 max-h-[300px] overflow-auto'
                                    : 'w-[60vw]'}`}
                                >
                                ...
                                {(message.generatedImages?.[0]?.isLoading) || message.content !== 'Đang tạo ảnh...' && (
                                    <div className={`flex mt-1 ${message.role === 'user' ? 'justify-end mr-2' : 'justify-start'}`}>
                                        <div className={`flex gap-2 ${message.role === 'user' ? 'relative' : ''}`}>
                                            <button
                                                onClick={() => {
